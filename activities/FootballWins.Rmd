...
The model is definitely more useful than not, but it does have a pretty significant amount of variance. 2 wins in an NFL season is a pretty big deviation, given the short season length. As such, you do have to take the results with a grain of salt. Be skeptical of its answers.
...
Points scored definitely seems to be the most important, but takeaways and giveaways also have an impact. My model was Wins ~ + Giveaways + Takeaways + `Points Scored`, which had an RSE of 1.532, which means the results vary by about 1.5 wins. It had an adjusted R-squared of 0.772, which means about 77% of the variability in wins is explained by the model. These are both pretty decent numbers, though they're not perfect. Yards gained, from our analysis of the earlier iteration of the model, did not seem to be very impactful to the model's results. 
...
Using this model, you could describe it to viewers/fans/readers as measuring the team's net amount of giveaways/takeaways and its number of points scored are the stats to watch for them to succeed. 
