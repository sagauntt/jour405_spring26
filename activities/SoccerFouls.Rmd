...
There is a very loose correlation between fouls and foal differential. The trend line is very very flat. The scatterplot is very dispersed. 
...
ANSWER: There is a positive correlation between the number of corner kicks and the goal differential, though its not the end-all-be-all. 
