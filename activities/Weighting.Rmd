...
Likely voters will respond more often to surveys, so there will be a better understanding of their expected turnout. But if there is a force that drives rarely/never voters to the polls, such as during Donald Trump's elections, that will be less understood or expected. It could lead to errors in voter turnout forecasts or polls. 
...
Rarely/never voters are harder to understand. They're less likely to vote and at the same time they're less likely to respond to surveys or harder to get a hold of. This means their perspective could be under-represented in the sample as they're simpler harder to poll. 
