...
gdp_data |> 
  ...
  labs(
    title = "Stock market performance closely tied to GDP")
```
...
There is a strong correlation between the two. DJIA and GDP have a correlation coefficient of 0.9531058, which is very strong. The scatter plot shows that as DJIA increases, the GDP tends to rise as well. But the effect does fall off slightly. After around the 30,000 point or so of DJIA there tends to be a bit more variance in how the GDP adjusts accordingly. 
