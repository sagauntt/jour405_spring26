...
The first anomaly I noticed is obviously the decrease in 2020. People were stuck at home during the height of the COVID-19 Pandemic, and thus there were less cars on the road. The other trend I notice is that crashes seem to be generally decreasing since a peak in 2021. I'd want to further investigate what led to the 2021 peak, and whether there have been changes since then to cause the overall decrease. It could be an interesting story to look into what the county is doing to decrease the number of crashes. 
...
Monday, Tuesday and Wednesday are all about tied for least crashes each week. Friday has the highest average number of crashes, with Saturday trailing just behind. This could be for multiple reasons. During the week, people are likely going to be driving to and from work, school or other routine places. But on the weekend, people might be venturing farther away as they likely have a free day. Additionally, it could be from more people drinking or going out Friday night/Saturday, leading to more accidents. 
...
Oct. 29, 2021, had multiple factors likely influencing its extremely high number of crashes. First, it was a Friday. This is in general is the day of the week with the highest number of crashes. Second, it was the Friday before Halloween. There were likely far more people out on the street late at night and intoxicated. Though COVID restrictions were still in place, there were still likely many people who wanted to celebrate the holiday after a year and a half of lockdowns. Lastly, there was heavy rain that night, making the road conditions dangerous. This context shows why the day had such an extraordinary number of crashes. 
...
The previously list contained almost exclusively Fridays and Saturdays. This list is more spread out across the week, containing Wednesdays, Tuesdays, Sundays, etc. I would be more likely to pull my analysis from this list, as it accounts for the flux in weekly driving patterns. Though some of the numbers might be smaller in terms of totals, they represent days with the highest differences, which I believe is more interesting to use.
...
January has the lowest number of average accidents. October has the highest. While conditions are likely poor in January, this might actually lead to more people staying home, and thus less drivers on the road. Many schools don't go back to session until mid-January or so, and some people choose to work from home over the holidays and new year. October may see more crashes as it is when the seasons begin to change. Colder weather and worsening road conditions, plus there aren't any stretches where school will be out or people won't be at work. There also could be a spike around Halloween. 
...
Most are Fridays or Saturdays. Many are in 2021. Additionally, there are far more days with a higher-than-average number of crashes than lower. 
...
Pitch: Car crashes have decreased steadily since around 2021. Why? What changes in the county have contributed? Is this an anomaly in the state or country, or mirroring national trends? 

HL: Car accidents Prince George's County fall to lowest amount in nearly 5 years

After reaching a peak in late 2021, the average number of car accidents in Prince George's County has steadily fallen. Now, the county is approaching its lowest number of crashes in five years. 

Sources: 
County data to show how rate of crashes has changed
PGPD
County Exec/Council, to look into whether the county has made any changes to increase road safety
National road safety organizations, like the NRSF or AAA Foundation for Traffic Safety, for national context
Insurers? Have their been less claims? 
